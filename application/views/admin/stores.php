          ...
          <div class="">
            <div class="page-title">
              <div class="title_left" style="width:100%;">
                <h3 style="text-align:center;"><?php echo lang('stores'); ?></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						echo form_open_multipart('reports/stores_pdf', $attributes);
					?>
					...
					<div class="form-group">
						<?php
							...
							echo form_label(lang('store'),'store',$data);
						?>
						...
						<?php
							if(!empty($stores))
							{
								...
								{
									$ourtypes0[$store->itid] = $store->itname;
								}											
								echo form_dropdown('store', $ourtypes0, array(), 'id="store" class="form-control" required="required"');
							}
