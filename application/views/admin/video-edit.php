          ...
          <div class="" >
            <div class="page-title">
              <div class="title_left" style="width:100%;">
                <h3 style="text-align:center;"><?php echo lang('edit_video'); ?></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						echo form_open_multipart('videosus/editvideo/'.$video->vdid, $attributes);
					?>
                    <!--<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">-->
					 ...
					 <div class="form-group">
						<?php
							...
							echo form_label(lang('link').' '.lang('youtube').' <span class="required">*</span>','link',$data);
						?>
                        <div class="col-md-6 col-md-pull-1 col-sm-6 col-sm-pull-2 col-xs-12">
						  <?php
							$data = array(
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-md-pull-1 col-sm-6 col-sm-pull-2 col-xs-12">
						  <?php
							...
							if($video->vdactive == '1') $data['checked'] = 'TRUE';
