          ...
          <div class="" >
            <div class="page-title">
              <div class="title_left" style="width:100%;">
                <h3 style="text-align:center;"><?php echo lang('edit_album'); ?></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						echo form_open_multipart('albums/editalbum/'.$album->alid, $attributes);
					?>
                    <!--<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">-->

					<input type="hidden" name="oldimg" value="<?php echo $album->alimg; ?>" />
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-md-pull-1 col-sm-6 col-sm-pull-2 col-xs-12">
						  <?php
							if(isset($album->alimg) && $album->alimg != '' && file_exists($album->alimg))
							{ 
								?><img src="<?php echo base_url().$album->alimg; ?>" class="img-responsive" style="max-width:150px;max-height:150px;"/><?php
								$data = array(
									'oldimg'  => $album->alimg
								);
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-md-pull-1 col-sm-6 col-sm-pull-2 col-xs-12">
						  <?php
							...
							if($album->alactive == '1') $data['checked'] = 'TRUE';
