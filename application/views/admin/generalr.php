          ...
          <div class="">
            <div class="page-title">
              <div class="title_left" style="width:100%;">
                <h3 style="text-align:center;"><?php echo lang('generalreport'); ?></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						echo form_open_multipart('reports/general_pdf', $attributes);
					?>
					...
					<div class="form-group">
						...
						<?php
							echo form_dropdown('type', array('UT'=>lang('usertypes'),'U'=>lang('users'),'BC'=>lang('branches'),'C'=>lang('customers'),'D'=>lang('delegates'),'IT'=>lang('itemtypes'),'IM'=>lang('itemmodels')), array(), 'id="store" class="form-control" required="required"');
						?>
                        </div>
                     </div>
