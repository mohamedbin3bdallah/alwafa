          ...
          <div class="">
            <div class="page-title">
              <div class="title_left" style="width:100%;">
                <h3 style="text-align:center;"><?php echo lang('outcomes'); ?></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						echo form_open_multipart('reports/outcomes_pdf', $attributes);
					?>
					...
					<div class="form-group">
						<?php
							...
							echo form_label(lang('branch').' - '.lang('store'),'branch',$data);
						?>
                        <div class="col-md-6 col-md-pull-1 col-sm-6 col-sm-pull-2 col-xs-12">
						<?php
							if(empty($branches) && empty($itemtypes))
							{
								echo lang('no_data');
							}
							else
							...
							if(!empty($branches))
							{
								...
								{
									$ourtypes0['B'.$branch->bcid] = lang('branch').' '.$branch->bcname;
								}											
							}
							if(!empty($itemtypes))
							{
								...
								{
									$ourtypes0['S'.$itemtype->itid] = lang('store').' '.$itemtype->itname;
								}											
							}
							echo form_dropdown('branch', $ourtypes0, array(), 'class="form-control" required="required"');
							}
						?>
                        </div>
                     </div>
