          ...
          <div class="">
            <div class="page-title">
              <div class="title_left" style="width:100%;">
                <h3 style="text-align:center;"><?php echo lang('add_about'); ?></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						echo form_open('aboutus/create', $attributes);
					?>
                    <!--<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">-->
					  ...
					  <div class="form-group">
						...
						<?php
							...
							echo form_dropdown('page', $ourtypes, array(), 'id="page" class="form-control"');
						?>
                        </div>
                      </div>
