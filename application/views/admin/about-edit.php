                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						echo form_open('aboutus/editabout/'.$about->abid, $attributes);
					?>
                    <!--<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">-->

					  <input type="hidden" name="myicon" id="myicon" value="<?php echo $about->abicon; ?>">
                        ...
                        <div class="col-md-6 col-md-pull-1 col-sm-6 col-sm-pull-2 col-xs-12">
						  <?php
							$data = array(
								...
								'class' => 'form-control col-md-7 col-xs-12',
								'value' => htmlspecialchars_decode(stripslashes($about->abdesc))
							);
					  ...
					  <div class="form-group">
						<?php
							...
							echo form_label(lang('frontpage').' <span class="required">*</span>','page',$data);
						?>
                        <div class="col-md-6 col-md-pull-1 col-sm-6 col-sm-pull-2 col-xs-12">
						<?php
							$ourtypes = array();
							$ourtypes[lang('about')] = lang('about');
							$ourtypes[lang('messages')] = lang('messages');
							echo form_dropdown('page', $ourtypes, array('page'=>$about->abpage), 'id="page" class="form-control"');
						?>
                        </div>
                      </div>
					  ...
					  <?php if($about->abicon) { ?>
							<?php
								...
								echo form_label(lang('icon').' <span class="required">*</span>','icon',$data);
							?>
							<div class="col-md-6 col-md-pull-1 col-sm-6 col-sm-pull-2 col-xs-12">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-md-pull-1 col-sm-6 col-sm-pull-2 col-xs-12">
						  <?php
							...
							if($about->abactive == '1') $data['checked'] = 'TRUE';
