          ...
          <div class="" >
            <div class="page-title">
              <div class="title_left" style="width:100%;">
                <h3 style="text-align:center;"><?php echo lang('edit_new'); ?></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						echo form_open_multipart('newsus/editnew/'.$new->nwid, $attributes);
					?>
                    <!--<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">-->
                        ...
                        <div class="col-md-6 col-md-pull-1 col-sm-6 col-sm-pull-2 col-xs-12">
						  <?php
							$data = array(
								...
								'class' => 'form-control col-md-7 col-xs-12',
								'value' => htmlspecialchars_decode(stripslashes($new->nwdesc))
							);
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-md-pull-1 col-sm-6 col-sm-pull-2 col-xs-12">
						  <?php
							if(isset($new->nwimg) && $new->nwimg != '' && file_exists($new->nwimg))
							{ 
								?><img src="<?php echo base_url().$new->nwimg; ?>" class="img-responsive" style="max-width:150px;max-height:150px;"/><?php
								$data = array(
									'oldimg'  => $new->nwimg
								);
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-md-pull-1 col-sm-6 col-sm-pull-2 col-xs-12">
						  <?php
							...
							if($new->nwactive == '1') $data['checked'] = 'TRUE';
