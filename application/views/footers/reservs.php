<!-- footer content -->
	...
	<script src="<?php echo base_url(); ?>js/sections.js"></script>
        ...
        var handleDataTableButtons = function() {
          if ($("#datatable-buttons").length) {
            $("#datatable-buttons").DataTable({
			  ...
			  'order': [[ <?php if(in_array('DP',$this->sections) && in_array('DR',$this->sections)) echo 8; elseif(in_array('DP',$this->sections)) echo 7; else echo 6; ?>, 'desc' ]],
              responsive: true
            });
          }
        };
