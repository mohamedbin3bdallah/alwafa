	...
	$(document).ready(function(){
		$("#type").change(function() {
			...
			$.ajax({
				...
				url:'<?php echo base_url(); ?>reports/type/',
				success: function (response) { document.getElementById("from").innerHTML = response.from; document.getElementById("to").innerHTML = response.to; }
			});
		});
	});
	</script>
	...
	$(document).ready(function(){
		$("#type").change(function(){
			...
			if(val == 'I')
			{
				$.ajax({
					type: 'POST',
					url: '<?php echo base_url(); ?>reports/getstores',
					data: {
					},
