	...
	<script>
		/*$(document).ready(function(){
			$("#shop").change(function() {
				...
				if(shop) window.location = "<?php echo base_url(); ?>orders/getitemsedit/"+order+"/"+shop+"/"+user+"/"+lat+"/"+lng+"/"+driver+"/"+status+"/"+active;
				else window.location = "<?php echo base_url(); ?>orders/edit/"+order;
			});
		});*/
		$(document).ready(function(){
			$('.add').click(function () {
