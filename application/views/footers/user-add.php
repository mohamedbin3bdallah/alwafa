	...
	<script>
					...
					$.ajax({
						...
						success: function (response) {
							...
							else if(response == 4)
							{
								$("#username").css("background-color", "#F5A9A9");
								$("#username_validation").css("color", "red");
								$("#username_validation").html('اسم المستخدم غير متاح');
								$("#username_validation_h").val('0');
								$("#submit").attr('disabled', 'true');
							}
							else if(response == 1)
							{
								...
								$("#username_validation").html('اسم المستخدم متاح');
		...
		$(document).ready(function(){
			$("#userType").change(function() {
				...
				if(userType == 4 || userType == 5) document.getElementById("smsresult").innerHTML = '<input type="submit" name="submit" value="<?php echo lang('save'); ?>" id="submit" class="btn btn-success" content="<?php echo lang('save'); ?>">';
				else if(smsCode == '117' && Number(smsNum) > '0') document.getElementById("smsresult").innerHTML = '<input type="submit" name="submit" value="<?php echo lang('save'); ?>" id="submit" class="btn btn-success" content="<?php echo lang('save'); ?>">';
				else document.getElementById("smsresult").innerHTML = '<h2 style="color:red; text-align:center;"><?php echo lang('cantadduser'); ?></div>'; 
				if($("#name_validation_h").val() == '0' || $("#email_validation_h").val() == '0' || $("#password_validation_h").val() == '0' || $("#cnfpassword_validation_h").val() == '0' || $("#username_validation_h").val() == '0') $("#submit").attr('disabled', 'true');
			});
		});
	</script>
