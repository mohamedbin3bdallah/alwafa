...
<head>
	...
	<meta name="description" content="<?php echo preg_replace('/(?:<|&lt;)\/?([a-zA-Z]+) *[^<\/]*?(?:>|&gt;)/', '', $new->nwdesc); ?>">
	<meta name="viewport" content="width=device-width, initial-scale=1">

	<meta property="og:url"           content="http://pixel4it.net/alwafa/new/<?php echo $new->nwurl; ?>" />
	<meta property="og:type"          content="article" />
	<meta property="og:title"         content="<?php echo $new->nwtitle; ?>" />
	<meta property="og:description"   content="<?php echo preg_replace('/(?:<|&lt;)\/?([a-zA-Z]+) *[^<\/]*?(?:>|&gt;)/', '', $new->nwdesc); ?>" />
	<meta property="og:image"         content="http://pixel4it.net/alwafa/<?php echo $new->nwimg; ?>" />

	<meta name="twitter:card" content="summary_large_image" />
	<!--<meta name="twitter:site" content="@nytimesbits" />
	<meta name="twitter:creator" content="@nickbilton" />-->

	<title><?php echo $new->nwtitle; ?></title>
				...
				<div class="row">
					<div class="col-sm-12 col-xs-12">
						<div class="th-pagetitle">
							<h1><?php if(isset($new) && !empty($new)) echo $new->nwtitle; else echo 'تفاصيل الخبر'; ?></h1>
						</div>
						<ol class="th-breadcrumb">
							<li><a href="<?php echo base_url(); ?>index">الرئيسية</a></li>
							<li><a href="<?php echo base_url(); ?>news">الاخبار</a></li>
							<li><span><?php if(isset($new) && !empty($new)) echo $new->nwtitle; else echo 'تفاصيل الخبر'; ?></span></li>
						</ol>
					</div>
				</div>
			</div>
			...
			*************************************-->
			<section class="th-sectionspace th-haslayout">
				<div class="container">
						...
						<div class="col-md-5 col-sm-5 col-xs-12">
							<article class="th-post th-postdetail">
									<figure class="th-postimg">
										<a href=""><img src="<?php echo base_url(); ?>/<?php echo $new->nwimg; ?>" alt="<?php echo $new->nwtitle; ?>"></a>
										<figcaption>
											<ul class="th-postmate">
												<li>
													<a href="">
														<i class="fa fa-calendar"></i>
														<span><?php if($new->nwtime != '') { echo ArabicTools::arabicDate($system->calendar.' Y-m-d', $new->nwtime); } ?></span>
													</a>
												</li>
												<li>
													<a href="">
														<i class="fa fa-eye"></i>
														<span><?php echo $new->nwviews; ?> مشاهدة</span>
													</a>
												</li>
												...
												<li>
													...
													<!--<div class="fb-share-button" data-href="http://pixel4it.net/alwafa/new/<?php echo $new->nwurl; ?>" data-layout="box_count" data-size="small" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;src=sdkpreparse">Share</a></div>-->
													<div data-href="http://pixel4it.net/alwafa/new/<?php echo $new->nwurl; ?>" data-layout="box_count" data-size="small" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http://pixel4it.net/alwafa/new/<?php echo $new->nwurl; ?>"><i class="fa fa-facebook"></i></a></div>
												</li>
												<li>
													<!--<a href="#">
													...
													<a href="https://twitter.com/share" data-via="" data-size="small" data-count="none" target="_blank"><i class="fa fa-twitter"></i></a>
												</li>
												<li>
													<!--<a href="#">
														<i class="fa fa-google-plus"></i>
													</a>-->
													<a href="https://plus.google.com/share?url=http://pixel4it.net/alwafa/new/<?php echo $new->nwurl; ?>" target="_blank"><i class="fa fa-google-plus"></i></a>
												</li>
												<li>
													<!--<a href="#">
														<i class="fa fa-linkedin"></i>
													</a>-->
													<a href="https://www.linkedin.com/shareArticle?mini=true&url=http://pixel4it.net/alwafa/new/<?php echo $new->nwurl; ?>&title=<?php echo $new->nwtitle; ?> &summary=<?php echo $new->nwtitle; ?>&source=LinkedIn" target="_blank"><i class="fa fa-linkedin"></i></a>
												</li>
											</ul>
										</figcaption>
									</figure>
								...
								<article class="th-post th-postdetail">
									<div class="th-postcontent">
										<div class="th-posttitel">
											<h2><?php echo $new->nwtitle; ?></h2>
										</div>
										<div class="th-description">
											<p><?php echo htmlspecialchars_decode(stripslashes($new->nwdesc)) ;?></p>
					...
					<?php } else echo '<div dir="rtl">ارجو التحقق من الرابط</div>';?>
					</div>
				</div>
