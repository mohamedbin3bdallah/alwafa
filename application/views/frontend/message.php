								...
								<div class="button"></div>
									<ul>
										...
										<li>
											...
											<ul>
												<li class='active'><a href="<?php echo base_url(); ?>message">رسالتنا</a></li>
				...
				<div class="container">
					...
					<?php if(isset($abouts) && !empty($abouts)) { ?>
						<div class="th-featuresarea">
							...
							<?php for($ab=0;$ab<count($abouts);$ab++) { ?>
								<li role="presentation" class="<?php if($ab == 0) echo 'active'; ?>">
									<a href="#<?php echo $abouts[$ab]->abid ;?>" role="tab" data-toggle="tab">
										<i class="fa <?php echo $abouts[$ab]->abicon ;?> fa-2x" aria-hidden="true"></i>
										<span><?php echo $abouts[$ab]->abtitle ;?></span>
									</a>
								</li>
							<?php } ?>
							</ul>
							...
							<?php for($ab=0;$ab<count($abouts);$ab++) { ?>
								<div role="tabpanel" class="tab-pane <?php if($ab == 0) echo 'active'; ?>" id="<?php echo $abouts[$ab]->abid ;?>">
									<h2><span><?php echo $abouts[$ab]->abtitle ;?></span></h2>
									<div class="th-description">
										<?php echo htmlspecialchars_decode(stripslashes($abouts[$ab]->abdesc)) ;?>
									</div>
								</div>
							<?php } ?>
							</div>
