									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class='active'><a href="<?php echo base_url(); ?>about">عن المستشـفى</a></li>						
											</ul>
										</li>
										<li>
			...
			<div class="container">
				<div class="row">
					<div id="th-twocolumns" class="th-twocolumns">
						<?php if(in_array('GL',$this->sections)) { ?><div class="col-md-9 col-sm-8 col-xs-12"><?php } else { ?><div class="col-md-12 col-sm-12 col-xs-12"><?php } ?>
						<?php if(isset($abouts) && !empty($abouts)) { ?>
							<div id="th-content" class="th-content">
								<div id="th-accordion" class="th-accordion">
									<?php foreach($abouts as $about) { ?>
									<div class="th-panel">
										<h4><?php echo $about->abtitle; ?></h4>
										<div class="th-panelcontent">
											<div class="th-description">
												<p>
													<?php echo htmlspecialchars_decode(stripslashes($about->abdesc)); ?>
												</p>
											</div>
										</div>
									</div>
