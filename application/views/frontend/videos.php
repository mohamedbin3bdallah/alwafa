...
<body>
									...
									<ul>
										...
										<li>
											...
											<ul>
												...
												<li class='active'><a href="<?php echo base_url(); ?>videos">مكتبة الفيديو</a></li>									
											</ul>
										</li>
		...
		<main id="th-main" class="th-main th-haslayout th-topbottompaddingzero">
			...
			*************************************-->
			...
			<?php if(isset($videos) && !empty($videos)) { ?>
				<div class="container">
					<?php for($vd=0;$vd<count($videos);$vd++) { ?>
					<?php if($vd%4 == 0) echo '<div class="row">'; ?>
						<div class="col-sm-3 col-xs-6">
							<article class="th-post">
								<div class="col-image_tn" ><a href="https://www.youtube.com/embed/<?php echo substr($videos[$vd]->vdlink, -11); ?>" data-showsocial="false" data-thumbnail="https://img.youtube.com/vi/<?php echo substr($videos[$vd]->vdlink, -11); ?>/hqdefault.jpg" class="html5lightbox" data-group="set1" title="<?php echo $videos[$vd]->vdtitle; ?>"><img src="https://img.youtube.com/vi/<?php echo substr($videos[$vd]->vdlink, -11); ?>/hqdefault.jpg"></a></div>
								
								<div class="th-postcontent">
									<div class="th-posttitel">
										<h3><a><?php echo $videos[$vd]->vdtitle; ?></a></h3>
									</div>
									<div class="th-description">
										<p><?php echo $videos[$vd]->vddesc; ?></p>
									</div>
								</div>
							</article>
						</div>
					<?php if($vd%4 == 3) echo '</div>'; ?>
					<?php } ?>
				</div>
				...
				<?php } ?>
			<?php } else echo '<div dir="rtl">لا توجد بيانات</div>';?>
			</section>
			<!--************************************
	...
	*************************************-->
	...
	<!-- Video Gallery -->
		<script type="text/javascript" src="<?php echo base_url(); ?>alwafa/js/html5lightbox.js"></script>
	<!-- End Video Gallery -->
</body>
</html>