			...
			*************************************-->
			<section class="th-sectionspace th-haslayout">
				...
				<?php if(isset($albums) && !empty($albums)) { ?>
					<?php for($al=0;$al<count($albums);$al++) { ?>
					<?php if($al%4 == 0) echo '<div class="row">'; ?>
						<div class="col-sm-3 col-xs-6">
							<article class="th-post">
								<div class='stackone'>
								   <a href="gallery/<?php echo $albums[$al]->alurl; ?>"><img src="<?php echo base_url(); ?>/<?php echo $albums[$al]->alimg; ?>" alt="<?php echo $albums[$al]->altitle; ?>" /></a>
								</div>
								<div class="th-postcontent">
									<div class="th-posttitel">
										<h3><a href="gallery/<?php echo $albums[$al]->alurl; ?>"><?php echo $albums[$al]->altitle; ?></a></h3>
									</div>
									<div class="th-description">
										<p><?php echo $albums[$al]->aldesc; ?></p>
									</div>
								</div>
							</article>
						</div>
					<?php if($al%4 == 3) echo '</div>'; ?>
					<?php } ?>
				<?php } ?>
				</div>
			</section>
