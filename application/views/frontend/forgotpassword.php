				...
				<div class="row">
					<div class="col-sm-12 col-xs-12">
						<div class="th-pagetitle">
							<h1><?php echo $this->pages['title'][$pageid]; ?></h1>
						</div>
						<ol class="th-breadcrumb">
							<li><a href="<?php echo base_url(); ?>index">الرئيسية</a></li>
							<li><span><?php echo $this->pages['title'][$pageid]; ?></span></li>
						</ol>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<?php
							...
							echo form_open('newpassword', $attributes);
							echo validation_errors();
						?>
							<?php if(isset($activemessage)) echo $activemessage; ?>
							<div class="col-md-12 col-sm-12 col-xs-12">
								<h3 class="text-right">البريد الالكتروني</h3>
							</div>
							<fieldset>
								<div class="col-md-12 col-sm-12 col-xs-12">
