...
<head>
	...
	<title>اهلا بكم فى الموقع الرسمي لمستشفى الوفاء</title>
								...
								<div class="button"></div>
									<ul>
										...
										<li>
											...
											<ul>
												<li class='active'><a href="<?php echo base_url(); ?>allgallery">معرض الصور</a></li>
				...
				<div class="row">
					<div class="col-sm-12 col-xs-12">
						...
						<ol class="th-breadcrumb">
							<li><a href="<?php echo base_url(); ?>index">الرئيسية</a></li>
							<li><a href="all-gallery.html">معرض الصور</a></li>
							<li><a href="#">اسم الالبوم</a></li>
						</ol>
					</div>
				</div>
			</div>
				...
				<div class="container">
					<div class="row">
						<div class="demo-gallery dark mrb35">
							<ul id="lg-share-demo" class="list-unstyled row">
								<li data-pinterest-text="Pin it1" data-tweet-text="share on twitter 1" class="col-xs-6 col-sm-4 col-md-3" data-src="images/gallery/00.jpg" data-sub-html="<h4>اسم الصورة</h4><p>صور بروشور وشهادة ودعوة مؤتمر مستشفى الوفاء العلمي الثاني لأمراض الباطنة والجهاز الهضمي والمناظير برئاسة دكتور محمد...</p>">
									<a href="#">
										<img class="img-responsive" src="images/gallery/00.jpg">
										<div class="demo-gallery-poster">
											<img src="images/zoom.png">
										</div>
									</a>
								</li>
								<li data-pinterest-text="Pin it2" data-tweet-text="share on twitter 2" class="col-xs-6 col-sm-4 col-md-3" data-src="images/gallery/01.jpg" data-sub-html="<h4>اسم الصورة 2</h4><p> الوفاء العلمي الثاني لأمراض الباطنة والجهاز الهضمي والمناظير برئاسة دكتور محمد...</p>">
									<a href="#">
										<img class="img-responsive" src="images/gallery/01.jpg">
										<div class="demo-gallery-poster">
											<img src="images/zoom.png">
										</div>
									</a>
								</li>
								<li data-pinterest-text="Pin it2" data-tweet-text="share on twitter 2" class="col-xs-6 col-sm-4 col-md-3" data-src="images/gallery/03.jpg" data-sub-html="<h4>اسم الصورة 3</h4><p>صور بروشور وشهادة ودعوة مؤتمر مستشفى الوفاء العلمي الثاني لأمراض الباط</p>">
									<a href="#">
										<img class="img-responsive" src="images/gallery/03.jpg">
										<div class="demo-gallery-poster">
											<img src="images/zoom.png">
										</div>
									</a>
								</li>
								<li data-pinterest-text="Pin it2" data-tweet-text="share on twitter 2" class="col-xs-6 col-sm-4 col-md-3" data-src="images/gallery/02.jpg" data-sub-html="<h4>اسم الصورة 4</h4><p>صور بروشور وشهادة ودعوة مؤتمر مستشفى الوفاء العلمي الثاني لأمراور محمد...</p>">
									<a href="#">
										<img class="img-responsive" src="images/gallery/02.jpg">
										<div class="demo-gallery-poster">
											<img src="images/zoom.png">
										</div>
									</a>
								</li>
								<li data-pinterest-text="Pin it2" data-tweet-text="share on twitter 2" class="col-xs-6 col-sm-4 col-md-3" data-src="images/gallery/04.jpg" data-sub-html="<h4>اسم الصورة 5</h4><p>صور بروشور وشهادة ودعوة مؤتمر مستشفى الوفاء العلمي الثاني لأمراض الباطنة والجهاز الهضمي والمناظير برئاسة دكتور محمد...</p>">
									<a href="#">
										<img class="img-responsive" src="images/gallery/04.jpg">
										<div class="demo-gallery-poster">
											<img src="images/zoom.png">
										</div>
									</a>
								</li>
								<li data-pinterest-text="Pin it2" data-tweet-text="share on twitter 2" class="col-xs-6 col-sm-4 col-md-3" data-src="images/gallery/03.jpg" data-sub-html="<h4>اسم الصورة 6</h4><p>صور بروشور وشهادة ودعوة مؤتمر مستشفى الوفاء العلمي الثاني لأمراض الباطنة والجهاز الهضمي والمناظير برئاسة دكتور محمد...</p>">
									<a href="#">
										<img class="img-responsive" src="images/gallery/03.jpg">
										<div class="demo-gallery-poster">
											<img src="images/zoom.png">
								...
								<li data-pinterest-text="Pin it2" data-tweet-text="share on twitter 2" class="col-xs-6 col-sm-4 col-md-3" data-src="images/gallery/01.jpg" data-sub-html="<h4>اسم الصورة 7</h4><p>صور بروشور وشهادة ودعوة مؤتمر مستشفى الوفاء العلمي الثاني لأمراض الباطنة والجهاز الهضمي والمناظير برئاسة دكتور محمد...</p>">
									<a href="#">
										<img class="img-responsive" src="images/gallery/00.jpg">
										<div class="demo-gallery-poster">
											<img src="images/zoom.png">
