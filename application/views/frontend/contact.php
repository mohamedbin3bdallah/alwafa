	...
	<div id="th-wrapper" class="th-wrapper th-haslayout">
							...
							<nav id='cssmenu'>
								...
								<div class="button"></div>
									<ul>
										...
										<li class='active'><a href="<?php echo base_url(); ?>contact">بيانات الاتصال</a></li>
									</ul>
							</nav>
						</nav>
				...
				<div class="row">
					<div class="col-sm-12 col-xs-12">
						...
						<ol class="th-breadcrumb">
							<li><a href="<?php echo base_url(); ?>index">الرئيسية</a></li>
							<li><span>بيانات الاتصال</span></li>
						</ol>
					</div>
				</div>
			</div>
		...
		*************************************-->
		<!--************************************
				Main Start
		*************************************-->
		<main id="th-main" class="th-haslayout th-paddingtopzero">
			<div class="container">
				<div class="row">
				<?php if(isset($contact) && !empty($contact) && $contact->ctactive == '1') { ?>
				<?php if(in_array('MG',$this->sections)) { ?><div class="col-md-4 col-sm-4 col-xs-12"><?php } else { ?><div class="col-md-12 col-sm-12 col-xs-12"><?php } ?>
				<div class="th-content th-sectionspace">
					
							
								<div class="th-sectiontitle">
									<h2> بيانات <span> الاتصال </span></h2>
								</div>
									
							
					
					<div class="th-description">
						<p>يسعدناو يشرفنا اتصالكم ... نعمل دائما على راحتكم</p>
					</div>
					<ul class="th-contactinfo">
						<?php if($contact->ctaddress != '') { ?>
						<li>
							<div class="th-infobox">
								<i class="th-iconbox"><img src="<?php echo base_url(); ?>alwafa/images/icon/img-08.png" alt="<?php echo $contact->ctaddress; ?>"></i>
								<address>
									<?php echo $contact->ctaddress; ?>
								</address>
							</div>
						</li>
						<?php } ?>
						...
						<li>
							<div class="th-infobox">
								<i class="th-iconbox"><img src="<?php echo base_url(); ?>alwafa/images/icon/img-09.png" alt="<?php echo $contact->ctphone.'-'.$contact->ctmobile; ?>"></i>
								<span><?php echo $contact->ctphone.'-'.$contact->ctmobile; ?></span>
							</div>
						</li>
						<?php } ?>
						...
						<li>
							<div class="th-infobox">
								<i class="th-iconbox"><img src="<?php echo base_url(); ?>alwafa/images/icon/img-10.png" alt="<?php echo $contact->ctemail; ?>"></i>
				...
				<?php } if(in_array('MG',$this->sections)) { ?>
					<?php if(isset($contact) && !empty($contact) && $contact->ctactive == '1') { ?><div class="col-md-8 col-sm-8 col-xs-12"><?php } else { ?><div class="col-md-12 col-sm-12 col-xs-12"><?php } ?>
					<div class="th-content th-sectionspace">
						
							
								<div class="th-sectiontitle">
									<h2> للاستفسار و <span> المقترحات </span></h2>
								</div>
